...
static Disassembler *Create6301(Application *pApp)
{
Disassembler *pDasm = new Dasm6301(pApp);
...
CMatrixEntry Dasm6301::h6301_codes[256] =
  {
...
Dasm6301::Dasm6301(Application *pApp)
  : Dasm6801(pApp)
{
codes = h6301_codes;
